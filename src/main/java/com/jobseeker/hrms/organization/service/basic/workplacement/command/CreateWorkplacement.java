...
public class CreateWorkplacement {
    ...
    public WorkplacementDataResponse execute(WorkplacementDataRequest request) {
        Workplacement workplacement = composeBranch(request, null);
