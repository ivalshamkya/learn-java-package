...
public class LawsonUpdateBusinessUnitService {
	...
	public BusinessUnitLWSDataResponse execute(BusinessUnitLWSDataRequest request, String oid) {
		BusinessUnitLawson data = composeData(request, oid);
