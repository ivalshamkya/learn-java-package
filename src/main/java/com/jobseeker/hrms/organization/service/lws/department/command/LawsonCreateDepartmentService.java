...
public class LawsonCreateDepartmentService {
	...
	public DepartmentLWSDataResponse execute(DepartmentLWSDataRequest request) {
		DepartmentLawson department = composeData(request, null);
