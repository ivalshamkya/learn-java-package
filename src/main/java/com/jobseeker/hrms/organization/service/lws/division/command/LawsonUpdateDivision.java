...
public class LawsonUpdateDivision {
    ...
    public DivisionLWSDataResponse execute(DivisionLWSDataRequest request, String oid) throws Exception {
        DivisionLawson divisionLawson = composeBranch(request, oid);
