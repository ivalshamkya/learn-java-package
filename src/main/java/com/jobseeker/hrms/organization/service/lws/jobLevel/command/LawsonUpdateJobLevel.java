...
public class LawsonUpdateJobLevel {
    ...
    public JobLevelDataResponse execute(JobLevelDataRequest request, String oid) {
        JobLevel jobLevel = composeBranch(request, oid);
