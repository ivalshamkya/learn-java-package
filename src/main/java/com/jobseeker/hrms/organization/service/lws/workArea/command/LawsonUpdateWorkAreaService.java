...
public class LawsonUpdateWorkAreaService {
	...
	public WorkAreaLWSDataResponse execute(WorkAreaLWSDataRequest request, String oid) {
		WorkAreaLawson department = composeData(request, oid);

		return mapper.toWorkAreaLWSDataResponse(department);
	}
