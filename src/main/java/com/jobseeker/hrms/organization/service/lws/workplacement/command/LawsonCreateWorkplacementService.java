...
public class LawsonCreateWorkplacementService {
	...
	public WorkplacementLWSDataResponse execute(WorkplacementLWSDataRequest request) {
		WorkplacementLawson data = composeData(request, null);
