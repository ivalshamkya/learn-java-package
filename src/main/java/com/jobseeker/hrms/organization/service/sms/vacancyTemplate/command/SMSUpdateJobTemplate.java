...
public class SMSUpdateJobTemplate {
    ...
    public JobTemplateDataResponse execute(JobTemplateDataRequest request, String oid) {
        VacancyTemplateSMS vacancyTemplateSMS = composeJobTemplate(request, oid);
